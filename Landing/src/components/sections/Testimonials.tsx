    ...
    >
      <div className="flex flex-col items-center justify-center gap-2 mb-12">
        <div className="border border-white/[0.2] flex flex-col items-center md:items-start mx-auto p-3 md:p-6 max-w-xs md:max-w-none relative">
          ...
          <h2 className="text-4xl font-heading font-semibold text-[#fbfffd] text-center md:text-left">
            Loved by people everywhere
          </h2>
        </div>
      </div>

      <div className="flex flex-col font-sans items-center justify-center md:max-w-none ">
        <InfiniteMovingCards
          items={testimonials}
          direction="left"
          speed="fast"
